...
struct SaveBlock2
{
    ...
    /*0x14*/ u16 optionsTextSpeed:3; // OPTIONS_TEXT_SPEED_[SLOW/MID/FAST]
             ...
             u16 optionsVolume:1; // Specifies whether the volume should be on or off
             u16 optionsTrack:5; // Specifies a song to play, up to 32 options (more room could be made)
